...
interaction.plot(goggles$alcohol, goggles$gender, goggles$attractiveness, 
                 ylab = "Attractiveness", xlab="# Drinks Consumed", names=c('none','2 drinks','4 drinks'),
...
# First let's check for variance homogeneity. 
# We can still use the leveneTest() function, as we did with one-way ANOVA,
# but now we need to adjust the arguments slightly:
...
#
#         Bonus: One effect is not significant. Why not?
